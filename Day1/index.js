...
console.log("Includes 'world':", str.includes("world")) //check if the string includes "world"
console.log("Replace 'world' with 'everyone':", str.replace("world", "everyone")) //replace "world" with "everyone"
...
// String str = "Maha"; int a = 5; boolean b = true;
let str2 = "Maha";
let a2 = 5;
let b2 = true;
